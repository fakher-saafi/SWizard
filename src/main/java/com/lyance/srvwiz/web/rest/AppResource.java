...
public class AppResource {
    ...
    public ResponseEntity<App> createApp(@RequestBody App app) throws URISyntaxException {
        ...
        RandomString key=new RandomString(20);
        String apikey=key.toString().replaceAll("net.bytebuddy.utility.RandomString@","");
        App result = appRepository.save(app.user(userService.getUserWithAuthorities().get()).apiKey(apikey));
